 ...
 * Version constants
 */
var X_MAILER_NAME = GLOBAL.X_MAILER_NAME || "Nodemailer",
    X_MAILER_HOMEPAGE = GLOBAL.X_MAILER_HOMEPAGE || "http://www.nodemailer.com/";
...
Nodemailer.prototype.setModuleHeaders = function(){
    ...
    if(this.options.messageId){
        ...
        messageId = crypto.randomBytes(15).toString("hex") +"@"+ this.resolveHostname(this.options.name);
    }
